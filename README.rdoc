...
1.Created static views for all static pages.
  --  Check views in Static Views Folder.
...
##############################################
          ...
          WRITE PROPER COMMENTS AND USE INTENDATION

  #################################################
  --------------------------------------------
  PUSH UPDATED CODE TO YOUR BRANCHS.
  WRITE PROPER COMMENTS AND USE INTENDATION.
  --------------------------------------------
  
   How to change a branch
--------------------------------------------------------------------------------------
git branch -d saikache
--------------------------------------------------------------------------------------

git branch -d branchname[chanakya]
--------------------------------------------------------------------------------------
